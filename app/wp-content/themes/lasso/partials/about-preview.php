...
?>
    <div class="lasso-about__teaser">
        <div class="lasso-about__teaser--photo-container">
            <img class="lasso-about__teaser--photo" src="<?php echo esc_url($about_teaser_photo); ?>" alt="<?php esc_attr($about_teaser_photo_alt); ?> ">
        </div>
        <div class="lasso-about__teaser--info">
            <h1 class="section__title lasso-about__teaser--title"><?php echo esc_html($about_teaser_title); ?></h1>
            <div class="section__sub-title lasso-about__teaser--text">
                <p>
                    <?php echo esc_html($about_teaser_text); ?>
                </p>
            </div>

            <div class="lasso-about__teaser--foot">
